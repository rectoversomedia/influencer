...
import { ChartLineUp, Users, Megaphone, ShieldCheck, Lightning, ArrowRight } from '@/app/icons';
      ...
      <section id="features" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { Icon: Megaphone, title: 'Campaign Management', desc: 'Create and manage influencer campaigns with customizable metrics and requirements.', gradient: 'from-indigo-500 to-indigo-600' },
              { Icon: ChartLineUp, title: 'Performance Analytics', desc: 'Real-time dashboards with automatic screenshot OCR to extract metrics instantly.', gradient: 'from-violet-500 to-violet-600' },
              { Icon: Users, title: 'Influencer Portal', desc: 'Dedicated portal for influencers to submit reports with automated screenshot analysis.', gradient: 'from-purple-500 to-purple-600' },
              { Icon: ShieldCheck, title: 'Client Dashboard', desc: 'Give your clients their own dashboard to track campaign progress and results.', gradient: 'from-emerald-500 to-emerald-600' },
              { Icon: Lightning, title: 'OCR Automation', desc: 'Automatically extract numbers from screenshots using advanced OCR technology.', gradient: 'from-amber-500 to-amber-600' },
              { Icon: ShieldCheck, title: 'Three User Roles', desc: 'Superadmin, Client, and Influencer - each with their own secure access.', gradient: 'from-rose-500 to-rose-600' },
            ].map((feature, i) => (
              <div key={i} className="group relative bg-white rounded-2xl border border-slate-200 p-8 hover:shadow-xl hover:shadow-slate-200/50 hover:border-slate-300/80 transition-all duration-300 hover:-translate-y-1">
      ...
      <section className="py-24 bg-gradient-to-br from-indigo-600 via-violet-600 to-purple-600 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-4xl lg:text-5xl font-bold text-white mb-6">
            Ready to Transform Your<br />Influencer Marketing?
          </h2>
